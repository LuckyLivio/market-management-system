        ...
        <div class="content">
            <div class="form-container">
                <div class="record-info">
                    <h3>记录信息</h3>
                    <p><strong>单号:</strong> ${fundOccupation.recordId}</p>
                    <p><strong>创建时间:</strong> <fmt:formatDate value="${fundOccupation.createdAt}" pattern="yyyy-MM-dd HH:mm:ss"/></p>
                </div>
                ...
                <form method="post" action="${pageContext.request.contextPath}/fund?action=edit">
                    <input type="hidden" name="recordId" value="${fundOccupation.recordId}">
                    ...
                    <div class="form-group">
                        ...
                        <select id="productCategory" name="productCategory" required>
                            ...
                            <c:forEach var="category" items="${categories}">
                                <option value="${category}" ${fundOccupation.productCategory == category ? 'selected' : ''}>${category}</option>
                            </c:forEach>
                            <option value="其他" ${fundOccupation.productCategory == '其他' ? 'selected' : ''}>其他</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="occupiedAmount" name="occupiedAmount" 
                               ...
                               value="${fundOccupation.occupiedAmount}" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="totalOccupied" name="totalOccupied" 
                               ...
                               value="${fundOccupation.totalOccupied}" 
                               onchange="calculateRatio()" required>
                    </div>
                    
                    <div class="form-group">
                        <label>占用比例</label>
                        <div id="ratioDisplay" class="ratio-display">
                            <fmt:formatNumber value="${fundOccupation.occupationRatio}" pattern="#0.00"/>%
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="statisticsDate" name="statisticsDate" 
                               value="<fmt:formatDate value='${fundOccupation.statisticsDate}' pattern='yyyy-MM-dd'/>" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="accountant">会计</label>
                        <input type="text" id="accountant" name="accountant" 
                               placeholder="请输入会计姓名" value="${fundOccupation.accountant}">
                    </div>
